...
ModuleCollision::ModuleCollision() : colliders{}
{
	...
	matrix[COLLIDER_HERO][COLLIDER_PASSIVE_MELEE] = false;
	...
	matrix[COLLIDER_WALL][COLLIDER_PASSIVE_MELEE] = false;
	...
	matrix[COLLIDER_ENEMY][COLLIDER_PASSIVE_MELEE] = false;
	...
	matrix[COLLIDER_BASE_ALERT][COLLIDER_PASSIVE_MELEE] = false;
	...
	matrix[COLLIDER_RECLUIT_IA][COLLIDER_PASSIVE_MELEE] = false;
	...
	matrix[COLLIDER_VISIBILITY][COLLIDER_PASSIVE_MELEE] = false;
	...
	matrix[COLLIDER_QUEST][COLLIDER_PASSIVE_MELEE] = false;
	...
	matrix[COLLIDER_PASSIVE_GATHERER][COLLIDER_PASSIVE_MELEE] = false;

	matrix[COLLIDER_PASSIVE_MELEE][COLLIDER_WALL] = false;
	matrix[COLLIDER_PASSIVE_MELEE][COLLIDER_HERO] = false;
	matrix[COLLIDER_PASSIVE_MELEE][COLLIDER_ENEMY] = true;
	matrix[COLLIDER_PASSIVE_MELEE][COLLIDER_BASE_ALERT] = false;
	matrix[COLLIDER_PASSIVE_MELEE][COLLIDER_RECLUIT_IA] = false;
	matrix[COLLIDER_PASSIVE_MELEE][COLLIDER_VISIBILITY] = false;
	matrix[COLLIDER_PASSIVE_MELEE][COLLIDER_QUEST] = false;
	matrix[COLLIDER_PASSIVE_MELEE][COLLIDER_PASSIVE_GATHERER] = false;
	matrix[COLLIDER_PASSIVE_MELEE][COLLIDER_PASSIVE_MELEE] = false;
