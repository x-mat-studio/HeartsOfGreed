...
GigaEnemy::GigaEnemy(fMPoint position, ENTITY_TYPE type, Collider* collider, Animation& walkLeft, Animation& walkLeftUp, Animation& walkLeftDown, Animation& walkRightUp,
...
GigaEnemy::GigaEnemy(fMPoint position, Enemy* copy, ENTITY_ALIGNEMENT align) :
