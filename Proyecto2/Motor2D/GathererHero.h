...
{
public:
	GathererHero(iMPoint position, Collider* col, Animation& walkLeft, Animation& walkLeftUp, Animation& walkLeftDown, Animation& walkRightUp,
	...
	GathererHero(iMPoint position, GathererHero* copy);
