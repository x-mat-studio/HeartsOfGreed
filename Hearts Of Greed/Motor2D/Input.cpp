...
bool ModuleInput::Start()
{
	...
	AddKeyBinding(SDL_SCANCODE_ESCAPE, KEY_STATE::KEY_UP, EVENT_ENUM::EXIT_MENUS);
	AddKeyBinding(SDL_SCANCODE_ESCAPE, KEY_STATE::KEY_DOWN, EVENT_ENUM::EXIT_CONSTRUCTION_MODE);
