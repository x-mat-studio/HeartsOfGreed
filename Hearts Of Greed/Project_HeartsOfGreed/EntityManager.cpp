...
ModuleEntityManager::ModuleEntityManager() :
	...
	sampleEmitterSkillRanged1(nullptr),
	sampleEmitterSkillRanged2(nullptr),
	sampleEmitterSkillRanged3(nullptr),
	sampleEmitterSkillRanged4(nullptr),
	sampleEmitterSkillRanged5(nullptr),
	sampleEmitterSkillRanged6(nullptr),
	sampleMeleeSkill1(nullptr),
	sampleMeleeSkill2(nullptr),
	sampleMeleeSkill3(nullptr),
	sampleMeleeSkill4(nullptr),
	sampleMeleeSkill5(nullptr),
	sampleMeleeSkill6(nullptr),
...
bool ModuleEntityManager::Start()
{
	...
	enemyRangedTexture = app->tex->Load("Assets/spritesheets/Enemies/Snipermingo.png");
	enemyGigaTexture = app->tex->Load("Assets/spritesheets/Enemies/Gigamingo.png");
	enemyNightTexture = app->tex->Load("Assets/spritesheets/Enemies/Speedomingo.png");

	//BUILDINGS--------
	buildingTexture = app->tex->Load("Assets/maps/base03.png");
	base1Texture = app->tex->Load("Assets/maps/base01.png");
	base2Texture = app->tex->Load("Assets/maps/base02.png");
	...
	upgradeCenterPlayerTexture = app->tex->Load("Assets/maps/upgradeCenter.png");
	upgradeCenterPlayerSelectedTexture = app->tex->Load("Assets/maps/upgradeCenter_selected.png");
	upgradeCenterEnemyTexture = app->tex->Load("Assets/maps/upgradeCenter_enemy.png");
	upgradeCenterEnemySelectedTexture = app->tex->Load("Assets/maps/upgradeCenter_enemy_selected.png");
	...
	moveCommandTileRobot = app->tex->Load("Assets/spritesheets/VFX/OnMyWatRobotto.png");
	debugPathTexture = app->tex->Load("Assets/maps/path.png");
	...
	//Wanamingo Sfx----
	wanamingoRoar = app->audio->LoadFx("Assets/audio/sfx/Wanamingo/Roar.wav");
	wanamingoRoar2 = app->audio->LoadFx("Assets/audio/sfx/Wanamingo/Roar2.wav");
	wanamingoGetsHit = app->audio->LoadFx("Assets/audio/sfx/Wanamingo/Hit.wav");
	wanamingoDies = app->audio->LoadFx("Assets/audio/sfx/Wanamingo/Death.wav");
	wanamingoDies2 = app->audio->LoadFx("Assets/audio/sfx/Wanamingo/Death2.wav");

	//Suitman sfx-----
	suitmanGetsHit = app->audio->LoadFx("Assets/audio/sfx/Heroes/Suitman/GetHit.wav");
	suitmanGetsHit2 = app->audio->LoadFx("Assets/audio/sfx/Heroes/Suitman/GetsHit2.wav");
	suitmanGetsDeath = app->audio->LoadFx("Assets/audio/sfx/Heroes/Suitman/Death.wav");
	suitmanGetsDeath2 = app->audio->LoadFx("Assets/audio/sfx/Heroes/Suitman/Death2.wav");
	suitman1Skill = app->audio->LoadFx("Assets/audio/sfx/Heroes/Suitman/Skill1.wav");
	suitman1Skill2 = app->audio->LoadFx("Assets/audio/sfx/Heroes/Suitman/Skill1_2.wav");

	noise1Armored = app->audio->LoadFx("Assets/audio/sfx/Heroes/Suitman/noise1.wav");
	noise2Armored = app->audio->LoadFx("Assets/audio/sfx/Heroes/Suitman/noise2.wav");
	noise3Armored = app->audio->LoadFx("Assets/audio/sfx/Heroes/Suitman/noise3.wav");
	noise4Armored = app->audio->LoadFx("Assets/audio/sfx/Heroes/Suitman/noise4.wav");
	...
	noise2Suitman = app->audio->LoadFx("Assets/audio/sfx/Heroes/Armoredman/noise2.wav");
	noise3Suitman = app->audio->LoadFx("Assets/audio/sfx/Heroes/Armoredman/noise3.wav");
	noise4Suitman = app->audio->LoadFx("Assets/audio/sfx/Heroes/Armoredman/noise4.wav");
	armored1Skill2 = app->audio->LoadFx("Assets/audio/sfx/Heroes/Armoredman/Skill1_2.wav");

	//Ranged sfx--------
	noise1Ranged = app->audio->LoadFx("Assets/audio/sfx/Heroes/Ranged/noise1.wav");
	noise2Ranged = app->audio->LoadFx("Assets/audio/sfx/Heroes/Ranged/noise2.wav");
	noise3Ranged = app->audio->LoadFx("Assets/audio/sfx/Heroes/Ranged/noise3.wav");
	noise4Ranged = app->audio->LoadFx("Assets/audio/sfx/Heroes/Ranged/noise4.wav");

	rangedGetsHit = app->audio->LoadFx("Assets/audio/sfx/Heroes/Ranged/rng_getsHit.wav");
	rangedDies = app->audio->LoadFx("Assets/audio/sfx/Heroes/Ranged/rng_dies.wav");

	ranged1Skill = app->audio->LoadFx("Assets/audio/sfx/Heroes/Ranged/skill1_launch.wav");
	ranged1Skil2 = app->audio->LoadFx("Assets/audio/sfx/Heroes/Ranged/skill1_cast.wav");

	//Robotto sfx-----------
	roboDying = app->audio->LoadFx("Assets/audio/sfx/Heroes/Robotto/provisionalDie.wav"); //Provisional SFX
	...
	hit1 = app->tex->Load("Assets/spritesheets/Particles/hit1.png");
	hit2 = app->tex->Load("Assets/spritesheets/Particles/hit2.png");
	hit3 = app->tex->Load("Assets/spritesheets/Particles/hit3.png");
	...
	//ranged skill
	sampleEmitterSkillRanged1->SetTextureNStart(spiderweb); 	sampleRangedSkill->PushEmiter(*sampleEmitterSkillRanged1);
	sampleEmitterSkillRanged2->SetTextureNStart(spiderweb); 	sampleRangedSkill->PushEmiter(*sampleEmitterSkillRanged2);
	sampleEmitterSkillRanged3->SetTextureNStart(spiderweb); 	sampleRangedSkill->PushEmiter(*sampleEmitterSkillRanged3);
	sampleEmitterSkillRanged4->SetTextureNStart(spiderweb); 	sampleRangedSkill->PushEmiter(*sampleEmitterSkillRanged4);
	sampleEmitterSkillRanged5->SetTextureNStart(spiderweb); 	sampleRangedSkill->PushEmiter(*sampleEmitterSkillRanged5);
	sampleEmitterSkillRanged6->SetTextureNStart(spiderweb); 	sampleRangedSkill->PushEmiter(*sampleEmitterSkillRanged6);

	//Melee skill
	sampleMeleeSkill1->SetTextureNStart(hit3); 	sampleMeleeSkill->PushEmiter(*sampleMeleeSkill1);
	sampleMeleeSkill2->SetTextureNStart(hit3); 	sampleMeleeSkill->PushEmiter(*sampleMeleeSkill2);
	sampleMeleeSkill3->SetTextureNStart(hit2); 	sampleMeleeSkill->PushEmiter(*sampleMeleeSkill3);
	sampleMeleeSkill4->SetTextureNStart(hit3); 	sampleMeleeSkill->PushEmiter(*sampleMeleeSkill4);
	sampleMeleeSkill5->SetTextureNStart(hit3); 	sampleMeleeSkill->PushEmiter(*sampleMeleeSkill5);
	sampleMeleeSkill6->SetTextureNStart(hit2); 	sampleMeleeSkill->PushEmiter(*sampleMeleeSkill6);
	return ret;
}
...
bool ModuleEntityManager::CleanUp()
{
	...
	app->tex->UnLoad(hit1);							hit1 = nullptr;
	app->tex->UnLoad(hit2);							hit2 = nullptr;
	app->tex->UnLoad(hit3);							hit3 = nullptr;
	...
	RELEASE(sampleMeleeSkill1);						sampleMeleeSkill1 = nullptr;
	RELEASE(sampleMeleeSkill2);						sampleMeleeSkill2 = nullptr;
	RELEASE(sampleMeleeSkill3);						sampleMeleeSkill3 = nullptr;
	RELEASE(sampleMeleeSkill4);						sampleMeleeSkill4 = nullptr;
	RELEASE(sampleMeleeSkill5);						sampleMeleeSkill5 = nullptr;
	RELEASE(sampleMeleeSkill6);						sampleMeleeSkill6 = nullptr;
...
bool ModuleEntityManager::LoadSampleParticleSystemsAndEmitters(pugi::xml_node& particleSystemsNode)
{
	...
	if (this != nullptr) {
		...
		float auxPosX = -100;							float auxPos2X = -100;							float auxPos3X = -100;
		float auxPosY = -100;							float auxPos2Y = -100;							float auxPos3Y = -100;
	...
	if (this != nullptr) {
		...
		Animation anim2;
		anim2.PushBack(SDL_Rect{ 0, 0, 40, 40 }, 1, 0, 0);

		Animation anim3;
		anim3.PushBack(SDL_Rect{ 0, 0, 40, 40 }, 1, 0, 0);
		...
		int particleVariationSpeedX = 0.5;			int particleVariationSpeedX2 = 0.7;			int particleVariationSpeedX3 = 0;
		int particleVariationSpeedY = 0;			int particleVariationSpeedY2 = 0;			int particleVariationSpeedY3 = 0.25;
		float particleAccelerationX = 0.3;			float particleAccelerationX2 = 0.25;		float particleAccelerationX3 = 0.05;
		float particleAccelerationY = -0.3;			float particleAccelerationY2 = -0.3;		float particleAccelerationY3 = 0.3;
		...
		sampleRangedSkill = new ParticleSystem();

		sampleEmitterSkillRanged1 = new Emitter(auxPosX, auxPosY, auxSpeedX, auxSpeedY, particleVariationSpeedX, particleVariationSpeedY, particleAccelerationX, particleAccelerationY, particleVariationAccelerationX, particleVariationAccelerationY, particleAngularSpeed, particleVariableAngularSpeed, particlesRate, particlesLifeTime, rect, nullptr, anim1, true);
		sampleEmitterSkillRanged2 = new Emitter(auxPos2X, auxPos2Y, auxSpeed2X, auxSpeedY2, particleVariationSpeedX2, particleVariationSpeedY2, particleAccelerationX2, particleAccelerationY2, particleVariationAccelerationX2, particleVariationAccelerationY2, particleAngularSpeed2, particleVariableAngularSpeed2, particlesRate2, particlesLifeTime2, rect, nullptr, anim2, true);
		sampleEmitterSkillRanged3 = new Emitter(auxPos3X, auxPos3Y, auxSpeed3X, auxSpeedY3, particleVariationSpeedX3, particleVariationSpeedY3, particleAccelerationX3, particleAccelerationY3, particleVariationAccelerationX3, particleVariationAccelerationY3, particleAngularSpeed3, particleVariableAngularSpeed3, particlesRate3, particlesLifeTime3, rect, nullptr, anim3, true);
		sampleEmitterSkillRanged4 = new Emitter(auxPosX, auxPosY, -auxSpeedX, auxSpeedY, -particleVariationSpeedX, particleVariationSpeedY, -particleAccelerationX, particleAccelerationY, -particleVariationAccelerationX, particleVariationAccelerationY, particleAngularSpeed, particleVariableAngularSpeed, particlesRate, particlesLifeTime, rect, nullptr, anim1, true);
		sampleEmitterSkillRanged5 = new Emitter(auxPos2X, auxPos2Y, -auxSpeed2X, auxSpeedY2, -particleVariationSpeedX2, particleVariationSpeedY2, -particleAccelerationX2, particleAccelerationY2, -particleVariationAccelerationX2, particleVariationAccelerationY2, particleAngularSpeed2, particleVariableAngularSpeed2, particlesRate2, particlesLifeTime2, rect, nullptr, anim2, true);
		sampleEmitterSkillRanged6 = new Emitter(auxPos3X, auxPos3Y, -auxSpeed3X, auxSpeedY3, -particleVariationSpeedX3, particleVariationSpeedY3, -particleAccelerationX3, particleAccelerationY3, -particleVariationAccelerationX3, particleVariationAccelerationY3, particleAngularSpeed3, particleVariableAngularSpeed3, particlesRate3, particlesLifeTime3, rect, nullptr, anim3, true);
	...
	if (this != nullptr)
	{
		...
		float particleAccelerationX = 0.3;			float particleAccelerationX2 = 0.1;			float particleAccelerationX3 = 0.025;
		float particleAccelerationY = +0.1;			float particleAccelerationY2 = -0.2;		float particleAccelerationY3 = -0.01;
		...
		float particlesRate = 2;					float particlesRate2 = 2;					float particlesRate3 = 2;
		float particlesLifeTime = 0.25;				float particlesLifeTime2 = 0.25;			float particlesLifeTime3 = 0.5;



		sampleMeleeSkill = new ParticleSystem();

		sampleMeleeSkill1 = new Emitter(auxPosX, auxPosY, auxSpeedX, auxSpeedY, particleVariationSpeedX, particleVariationSpeedY, particleAccelerationX, particleAccelerationY, particleVariationAccelerationX, particleVariationAccelerationY, particleAngularSpeed, particleVariableAngularSpeed, particlesRate, particlesLifeTime, rect, nullptr, anim3, true);
		sampleMeleeSkill2 = new Emitter(auxPos2X, auxPos2Y, auxSpeed2X, auxSpeedY2, particleVariationSpeedX2, particleVariationSpeedY2, particleAccelerationX2, particleAccelerationY2, particleVariationAccelerationX2, particleVariationAccelerationY2, particleAngularSpeed2, particleVariableAngularSpeed2, particlesRate2, particlesLifeTime2, rect, nullptr, anim3, true);
		sampleMeleeSkill3 = new Emitter(auxPos3X, auxPos3Y, auxSpeed3X, auxSpeedY3, particleVariationSpeedX3, particleVariationSpeedY3, particleAccelerationX3, particleAccelerationY3, particleVariationAccelerationX3, particleVariationAccelerationY3, particleAngularSpeed3, particleVariableAngularSpeed3, particlesRate3, particlesLifeTime3, rect, nullptr, anim2, true);

		sampleMeleeSkill4 = new Emitter(auxPosX, auxPosY, -auxSpeedX, auxSpeedY, -particleVariationSpeedX, particleVariationSpeedY, -particleAccelerationX, particleAccelerationY, -particleVariationAccelerationX, particleVariationAccelerationY, particleAngularSpeed, particleVariableAngularSpeed, particlesRate, particlesLifeTime, rect, nullptr, anim3, true);
		sampleMeleeSkill5 = new Emitter(auxPos2X, auxPos2Y, -auxSpeed2X, auxSpeedY2, -particleVariationSpeedX2, particleVariationSpeedY2, -particleAccelerationX2, particleAccelerationY2, -particleVariationAccelerationX2, particleVariationAccelerationY2, particleAngularSpeed2, particleVariableAngularSpeed2, particlesRate2, particlesLifeTime2, rect, nullptr, anim3, true);
		sampleMeleeSkill6 = new Emitter(auxPos3X, auxPos3Y, -auxSpeed3X, auxSpeedY3, -particleVariationSpeedX3, particleVariationSpeedY3, -particleAccelerationX3, particleAccelerationY3, -particleVariationAccelerationX3, particleVariationAccelerationY3, particleAngularSpeed3, particleVariableAngularSpeed3, particlesRate3, particlesLifeTime3, rect, nullptr, anim2, true);
	}
	//BUILDING SMOKE
	if (this != nullptr)
	{
