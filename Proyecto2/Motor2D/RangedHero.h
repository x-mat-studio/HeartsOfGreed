...
{
public:
	RangedHero(iMPoint position, Collider* col, Animation& walkLeft, Animation& walkLeftUp, Animation& walkLeftDown, Animation& walkRightUp,
	...
	RangedHero(iMPoint position, RangedHero* copy);
