...
{
public:
	MeleeHero(iMPoint position, Collider* col, Animation& walkLeft, Animation& walkLeftUp, Animation& walkLeftDown, Animation& walkRightUp,
	...
	MeleeHero(iMPoint position, MeleeHero* copy);
